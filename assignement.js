...
let famous_person = "Shaikh Saadi R.A";
let Message = "The best loved by God are those that are rich, yet have the humility of the poor, and those that are poor and have the magnanimity of the rich.";
...
// Print that message.
let favNum = 11;
let mymessage = "my favourite number is";
...
var names = ["afzal", "noman", "farman", "shahid", "suleman"];
// console.log(names[0]);
// console.log(names[1]);
// console.log(names[2]);
// console.log(names[3]);
...
let guests = ["Noman", "Shahid", "Mian Suleman", "Mian Farman"];
...
guests.forEach((guests) => {
    console.log(`I'm iforming you ${guests} you that I found bigger table in dinner so I'm inviting more friends tonight`);
...
// List shrinking
guests.forEach((guests) => {
    console.log(`Hello Dear ${guests} I'm informing you that I'hv space for only two guest at Dinner`);
});
// Remove Guests from list
while (guests.length > 2) {
    let removeGuest = guests.pop();
    console.log(`I'm Soory ${removeGuest} that you are not invited at Dinner Tonight`);
}
...
let foodlist = ["Pizza", "Burger", "salad", "rice"];
...
let usernames = ['admin', 'zaid', 'awais', 'usama', 'uzair'];
